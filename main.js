...
const sectionens = document.querySelectorAll(".section");

sectionens.forEach(function (sectionen) {
    sectionen.addEventListener("click", function () {
        document.querySelector(".portfolio-navbar").classList.remove("show");
    });
});
...
var typed = new Typed('#element', {
    strings: ['Content Creator', 'Social media specialist', 'Graphic Designer',' Copy Writer'],
    typeSpeed: 70,
    loop: true,
    delay:10,
});
...
const resumeHeading = document.querySelector(".cv-heading");
const resumeTabs = document.querySelectorAll(".cv-tab");
...
(function () {
    ...
    emailjs.init("uIsxAErHNZaGVVYc9");
})();
...
window.onload = function () {
    document
        ...
        .addEventListener("submit", function (event) {
            ...
            emailjs.sendForm("service_resfjqo", "template_15n8luk", this).then(
                function () {
...
sr.reveal(
    ".cv-heading,.cv-text,.service-row,.portfolio-wrapper,.contact-general,#contact-form",
    {
        origin: "bottom",
    }
);
